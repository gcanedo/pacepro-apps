// pp-race-app fd42d7c0a62f v32978d2a9e94
const CACHE='pp-race-app-fd42d7c0a62f-32978d2a9e94';
const TILES='pp-race-app-fd42d7c0a62f-tiles';
...
self.addEventListener('activate',e=>{e.waitUntil((async()=>{
  ...
  const prefix='pp-race-app-fd42d7c0a62f';
